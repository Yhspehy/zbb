...
```js
     ...
     * 
     * 注意：由于使用weex进行hybrid开发，而native端是没有html的，所以不能解析了html代码了
     * 所以现在要传数据的数组，如果当前页面块是图片的则传img字符串，并将图片链接放在后面。格式为"img=url"
    ...
    return {
        ...
        "data": {
            ...
            "content": [
                ...
                "北京时间7月1日中午12点，联盟自由球员市场已经正式开启，保罗、乔治、杜兰特、约基奇等多名球员签下大合同，他们的薪水比上赛季都有不小的增长，下面我们来看看2018-19赛季哪些球员的薪水排名联盟前列（考辛斯等还未确定合同金额的球员没有列入。",
                "1、斯蒂芬-库里（3746万美元）去年夏天，库里与勇士达成续约协议，他符合指定老将条款的规定，可以拿到起薪最高为35%、最长五年、每年工资涨幅为8%的超级顶薪，库里与勇士签订了一份5年总价值2.01亿美元的顶薪合同，新赛季他的薪水是3746万美元。"
            ]
        }
    }
```   
